...
def test_change_cat_add_cat():
    ...
    time.sleep(2)
    button4 = browser.find_element(By.CLASS_NAME, "text.text_type_large.text_color_white.pl-8.button-header_text__1pP0C.false.button-header_hidden__Ay3Pt")
    button4.click()
