...
def test_change_new_cat():
    ...
    time.sleep(2)
    input3 = browser.find_element(By.XPATH, "//input[@name='name']")
    input3.send_keys("Murzik666")

    time.sleep(1)
    input3 = browser.find_element(By.XPATH, "//input[@name='birth_year']")
    input3.send_keys("1999")

    time.sleep(1)
    button2 = browser.find_element(By.CLASS_NAME, "button-form_button__4mpE0.edit-card-page_submit_btn__zkld2")
    button2.click()
