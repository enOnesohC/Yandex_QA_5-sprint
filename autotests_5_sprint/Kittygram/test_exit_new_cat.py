...
#выходим по кнопке разлогинивания

def test_new_cat_exit():
    ...
    time.sleep(2)
    button3 = browser.find_element(By.CLASS_NAME, "button-secondary_button__rvAvn.card-page_desktop_btn__L8ADJ.card-page_desk_return__SM2fy")
    button3.click()
